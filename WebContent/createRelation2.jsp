...
<br /><br />
   ...
   <br />
		...
		<option value="varchar(50)">unit</option>
</select>&nbsp;&nbsp;中心节点：	<select id="valueStyle" name="valueStyle">
			<option value="varchar(50)">人民币</option>
		
</select>	&nbsp;&nbsp;	<input  type="button" id="addAtrri" value="添加中心节点"/>  <br /><br /></div>
		...
		<p>
		<input name="concept"/>&nbsp;&nbsp;	
	 &nbsp; <input type="button" id="delete2" value="=">		
  &nbsp; <input  value=""/>
   &nbsp; <input type="button" id="delete2" value="*">
   <select id="valueStyle" name="valueStyle">
			<option value="varchar(50)">人民币</option>
 ...
 &nbsp; <input  value=""/>
      ...
      <div id="attributes" >   </div>  
        ...
        <p></p> 
    <input  type="button" id="addAtrri" value="添加一次转换函数"/> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;    <input  type="button" id="addAtrri" value="添加非一次转换函数"/>  
      <p></p> 
