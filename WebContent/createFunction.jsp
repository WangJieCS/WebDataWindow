...
<br /><br />
   ...
   <br />
		...
		=
		<select id="valueStyle" name="valueStyle">
			<option value="varchar(50)">a</option>
		<option value="varchar(50)">1</option>
</select>
<select id="valueStyle" name="valueStyle">
			
		<option value="varchar(50)">*</option>
		<option value="varchar(50)">/</option>
		<option value="varchar(50)">abs</option>
		<option value="varchar(50)">sqrt</option>
</select>
X^<input name="concept" style="width:20px;"/>&nbsp;&nbsp; + 

&nbsp;&nbsp;	 
	<select id="valueStyle" name="valueStyle">
			<option value="varchar(50)">b</option>
		<option value="varchar(50)">1</option>
</select>
<select id="valueStyle" name="valueStyle">
...
X^
<input name="concept" style="width:20px;"/>
 <br /><br /></div>
   ...
   &nbsp; </p>
      ...
      <div id="attributes" >   </div>  
        ...
        <p></p> 
    <input  type="button" id="addAtrri" value="添加项"/> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  
      <input  type="button" id="addAtrri" value="删除项"/>  
      <p></p> 
